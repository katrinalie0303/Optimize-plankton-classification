...
MADE_ZOO_WEIGHTS = "model_zooscan_weights.h5"
...
def create_densenet169_model_opt(classes, weights=DEFAULT_WEIGHTS, input_shape=DEFAULT_INPUT_SHAPE):
    """Creates the DenseNet169 model.
    ...
    # Add fully connected layers #use another act func adam
    x= Dense(1024,activation='relu')(x)
    x= Dense(512,activation='relu')(x) 
...
def create_densenet169_model_opt_weights(classes, weights=MADE_ZOO_WEIGHTS, input_shape=DEFAULT_INPUT_SHAPE):
    """Creates the DenseNet169 model.
