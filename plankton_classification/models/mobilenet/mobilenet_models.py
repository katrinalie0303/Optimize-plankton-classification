...
def create_mobilenetv3_large_model_opt(num_classes, weights=DEFAULT_WEIGHTS, input_shape=DEFAULT_INPUT_SHAPE):
    """
    Create a new MobilenetV3Large model with transfer learning. 
...
def create_mobilenetv3_large_model_opt_weights(num_classes, weights=MADE_ZOO_WEIGHTS, input_shape=DEFAULT_INPUT_SHAPE):
    """
    Create a new MobilenetV3Large model with transfer learning. 
