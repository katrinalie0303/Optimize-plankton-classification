from sklearn.metrics import confusion_matrix, precision_recall_curve, roc_curve, precision_score, recall_score, f1_score, average_precision_score, accuracy_score
...
def plot_confusion_matrix(y_true, y_pred, class_names, normalize=False):
    ...
    plt.figure(figsize=(73, 73)) #(12, 10)
